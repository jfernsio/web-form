  ...
  newExperience.innerHTML = `
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" class="experience-salary" placeholder="1234567"
                      pattern="[0-9]{1,7}"
                      maxlength="7"
                      inputmode="numeric"/>
            </div>
...
document.getElementById('applicationForm').addEventListener('submit', async function(event) {
  ...
  const backendUrl = 'https://3cww7b0d-5000.inc1.devtunnels.ms/api/v1/apply/degree-college'; //'https://web-form-g7a5.onrender.com/api/v1/apply/degree-college'
